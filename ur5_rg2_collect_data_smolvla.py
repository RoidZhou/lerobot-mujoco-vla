...
from mujoco_env.ur5_rg2_env import SimpleEnv2
...
REPO_NAME = 'omy_nutbolt_language'
NUM_DEMO = 1 # Number of demonstrations to collect
ROOT = "./demo_data_nutbolt_language" # The root directory to save the demonstrations


xml_path = './asset/scene_ur5_rg2_boltnut.xml'
...
while PnPEnv.env.is_viewer_alive() and episode_id < NUM_DEMO:
    ...
    if PnPEnv.env.loop_every(HZ=20):
        debug_tick += 1
        if debug_tick % 20 == 0:
            print(PnPEnv.get_alignment_debug())
            print(PnPEnv.get_contact_force_debug())
